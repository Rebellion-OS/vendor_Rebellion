...
custom_dependencies = "rebellion.dependencies"
org_manifest = "RebellionOS-Devices"  # leave empty if org is provided in manifest
org_display = "RebellionOS-Devices"  # needed for displaying
